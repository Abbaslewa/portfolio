        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="flex flex-col w-full md:w-2/3 bg-gray-800 p-6 sm:p-12 rounded-lg shadow-lg">
            <div className="flex justify-center md:justify-start space-x-4 border-b border-gray-600 pb-4 mb-4">
              <a href="#project" className="text-yellow-500 font-extrabold  hover:underline">Project</a>
              <a href="#education" className="text-white font-extrabold hover:text-yellow-500 hover:underline">Education</a>
            </div>

            <div className="text-white">
              <p className="leading-relaxed font-extrabold text-base sm:text-lg mb-6 text-gray-300">
