...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-4 sm:space-y-6 px-4 sm:px-6 md:px-10">
        <h1 className="text-xl sm:text-3xl p-3 animate-pulse rounded-lg font-extrabold text-gray-100">
          Hi, I'm Abbas Omer 👋
        </h1>
        ...
        <div className="flex space-x-4">
          <a
            href="#contact"
            className="relative inline-block px-4 sm:px-6 py-2 text-white font-semibold bg-gradient-to-r from-yellow-500 to-red-500 rounded-lg shadow-lg  duration-500"
  ...
  <div className="text-center bg-white bg-opacity-10 text-white p-4 rounded-lg shadow-lg transition-transform duration-300 hover:scale-105 hover:rotate-2 animate-float">
